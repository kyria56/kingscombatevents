...
document.addEventListener('DOMContentLoaded', () => {
    ...
    setTimeout(() => {
        ...
        setTimeout(() => {
            ...
            // Start hero background cycling after loading screen is gone
            ...
            const changeHeroBackground = () => {
                ...
                // Construct the full background property string, including the gradient and image
                heroSection.style.backgroundImage = `linear-gradient(rgba(26, 26, 26, 0.85), rgba(26, 26, 26, 0.85)), url('${heroImages[currentImageIndex]}')`;
            };

            // Change background every 4 seconds (adjust as needed)
